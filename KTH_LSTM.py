...
trg_data_root = "/nfs/trg_data/master/public/KTH/"
...
print ("Loading data")
# load training data: I could not load all, so I selected 1-7
X_train, y_train = load_data_for_persons(trg_data_root, 1, 8, maxToAdd)
# NOTE: using DataGenerator should allow loading much larger datasets
# will update the code when I find out how to do that
